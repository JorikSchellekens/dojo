...
import { strToShortStringFelt } from '../dist/utils/index.js'
...
const main = async () => {
    ...
    const keys = [BigInt(0x2a79e6863214cfb96bdcb42b70eb39cdb74dd7787d2b1e792b673600892eeb2)]

    const poseidon = microstarknet.poseidonHashMany(keys)

    const query = { address_domain: 0, partition: 0, keys: keys, hash: poseidon };
    const offset = 0;
    const length = 0;
